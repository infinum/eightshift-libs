...
final class InvalidPath extends InvalidArgumentException implements GeneralExceptionInterface
{
	 ...
	 * @return static
	 */
	public static function missingDirectoryException(string $path): InvalidBlock
	{
	 ...
	 * @return static
	 */
	public static function missingFileWithExampleException(string $path): InvalidBlock
	{
		return new InvalidBlock(
			\sprintf(
