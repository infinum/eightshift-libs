...
/**
 * Class that registers WP-CLI command initial setup of theme project using npx command for clean no blocks setup.
 *
...
/**
 * Class InitThemeCleanSetupCli
 */
class InitThemeCleanSetupCli extends AbstractCli
{
	/**
	...
	public function getDoc(): array
	{
		return [
			...
			'longdesc' => $this->prepareLongDesc("
				...
				Used to setup theme from the initial boilerplate with no blocks setup.
	...
	public function __invoke(array $args, array $assocArgs)
	{
		...
		$dir = __DIR__ . "{$sep}clean{$sep}theme";
		...
		WP_CLI::runcommand(\sprintf("boilerplate init theme-clean --%s=true", self::ARG_GROUP_OUTPUT));
		$this->cliLog('--------------------------------------------------', 'C');
