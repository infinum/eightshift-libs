...
class CliInitAll extends AbstractCli
{
	...
	{
		return [
			'shortdesc' => 'Generates initial setup for all service classes in the WordPress theme project. For this to work you must set global constant ES_DEVELOP_MODE to true.',
		];
	}
