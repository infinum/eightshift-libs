...
abstract class AbstractCli implements CliInterface
{
	...
	protected function getIntroText(array $arg = []): void
	{
		...
		*/
		...
		%k▒▒▒▒▒▒▒▒▒▒▒%R█████████▒▒▒▒▒▒▒▒▒▒▒▒▒▒%R█████████%k▒▒▒▒▒▒▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒%n
		%k▒▒▒▒▒▒▒▒%R████▒▒▒▒▒▒▒%R████▒▒▒▒▒▒▒▒%R████▒▒▒▒▒▒▒%R████▒▒▒▒▒▒▒▒▒▒▒%8▓▓▓▓%n%k▒▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒%8▓▓▓▓%n%k▒▒▒%8▓▓▓▓▓▓▓%n%k▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒▒%8▓▓▓▓%n%k▒▒▒▒▒%8▓▓▓▓▓▓▓%n%k▒▒▒%8▓▓▒▒▒%8▓▓▓▓%n%k▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒%n
		%k▒▒▒▒▒▒%R███▒▒▒▒▒▒▒▒▒▒▒▒▒%R███▒▒▒▒%R███▒▒▒▒▒▒▒▒▒▒▒▒▒%R███▒▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒%n
		%k▒▒▒▒▒%R███▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒%R█████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒%R███▒▒▒▒▒▒▒▒%8▓▓▓▓▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▒▒%8▓▓▓▓%n%k▒▒▒▒▒▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒%8▓▓▓▓▓▓%n%k▒▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒%n
		%k▒▒▒▒%R███▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒%R███▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒%R███▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒%n
		%k▒▒▒▒▒%R███▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒%R█████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒%R███▒▒▒▒▒▒▒▒%8▓▓▓▓▓▓%n%k▒▒▒▒▒%8▓▓▓▓▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▒%8▓▓▒▒▒%8▓▓▒▒▒%8▓▓▓▓▓▓▓▓%n%k▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒%n
		%k▒▒▒▒▒▒%R███▒▒▒▒▒▒▒▒▒▒▒▒▒%R███▒▒▒%R███▒▒▒▒▒▒▒▒▒▒▒▒▒▒%R███▒▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒%8▓▓▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒%n
		%k▒▒▒▒▒▒▒▒%R████▒▒▒▒▒▒▒%R████▒▒▒▒▒▒▒%R████▒▒▒▒▒▒▒%R████▒▒▒▒▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓▓▓%n%k▒▒▒▒▒▒▒%8▓▓%n%k▒▒%8▓▓%n%k▒▒▒▒▒%8▓▓▓▓%n%k▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒%n
		%k▒▒▒▒▒▒▒▒▒▒▒%R█████████▒▒▒▒▒▒▒▒▒▒▒▒▒%R█████████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒%8▓▓%n%k▒▒▒▒▒%8▓▓%n%k▒▒%8▓▓%n%k▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒%n
