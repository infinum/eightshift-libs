...
abstract class AbstractCli implements CliInterface
{
	...
	protected function getIntroText(array $arg = []): void
	{
		...
		*/
		...
		%k▒▒▒▒▒▒▒▒%R████%n%k▒▒▒▒▒▒▒%R████▒▒▒▒▒▒▒▒%R████%n%k▒▒▒▒▒▒▒%R████%n%k▒▒▒▒▒▒▒▒▒▒▒%8▓▓▓▓%n%k▒▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒%8▓▓▓▓%n%k▒▒▒%8▓▓▓▓▓▓▓%n%k▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒▒%8▓▓▓▓%n%k▒▒▒▒▒%8▓▓▓▓▓▓▓%n%k▒▒▒%8▓▓▒▒▒%8▓▓▓▓%n%k▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒%n
		%k▒▒▒▒▒▒%R███%n%k▒▒▒▒▒▒▒▒▒▒▒▒▒%R███▒▒▒▒%R███%n%k▒▒▒▒▒▒▒▒▒▒▒▒▒%R███%n%k▒▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒▒▒▒%8▓▓%n%k▒▒▒▒▒▒▒%n
